...
**Prefer a ready-made component?** The turnkey [`<GridLayout>`](https://snapgrid.dev/react/docs/guides/component-layer) wraps these same hooks (and supplies the provider) in a react-grid-layout-style API:
