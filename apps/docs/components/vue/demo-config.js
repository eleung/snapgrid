// Shared demo constants, mirroring the React gallery (components/demos.tsx) and the
// Svelte one (components/svelte/demo-config.ts) so the three galleries render the same
// structure, geometry, and layouts. Plain JS (no `lang="ts"` anywhere in the Vue demos):
// Next's SWC pipeline compiles the SFC blocks, so the demo modules stay JS too.
...
export const NESTED_OUTER = [
  { i: "panel", x: 0, y: 0, w: 8, h: 4 },
  { i: "a", x: 8, y: 0, w: 4, h: 2 },
  { i: "b", x: 8, y: 2, w: 4, h: 2 },
];
export const NESTED_INNER = [
  { i: "1", x: 0, y: 0, w: 2, h: 1 },
  { i: "2", x: 2, y: 0, w: 2, h: 1 },
  { i: "3", x: 4, y: 0, w: 2, h: 1 },
  { i: "4", x: 0, y: 1, w: 4, h: 1 },
...
export const INTEROP_GRID_INIT = [
