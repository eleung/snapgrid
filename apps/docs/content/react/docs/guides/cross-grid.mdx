...
<Callout type="info">
  ...
  sortable (a list, a kanban column), see [dnd-kit interop](/react/docs/guides/dnd-kit-interop).
</Callout>
...
<Callout type="info">
  ...
  [`<GridLayout>`](/react/docs/guides/component-layer) with keyed children inside the same group; it
  bundles the container and items for you.
</Callout>

<Callout type="info">
  **No overlay to wire.** A dragged tile [floats itself](/react/docs/guides/headless#floating) — it lifts
...
<Callout type="info">
  ...
  [Nested grids](/react/docs/guides/nesting) — they also cross levels by default, and you can give a
