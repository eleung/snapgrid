...
The framework-agnostic layout math. The dnd-kit engine (`@snapgridjs/dnd`) and the React bindings
build on it, so you rarely import it directly. Reach for it when integrating snapgrid into a
non-React renderer, building custom tooling, or testing layout logic in isolation.
...
<Callout type="warning">
  ...
  [Compaction](/react/docs/guides/compaction#extra-packers).
</Callout>
