...
draggables, use the hooks. See the [Component layer guide](/docs/guides/component-layer) for usage;
this page is the prop reference.

A dragged tile [floats itself](/docs/guides/headless#floating), so there's no overlay component to
...
| `accept` | `(source) => boolean` | — | [dnd-kit interop](/docs/guides/dnd-kit-interop): also accept a foreign sortable as a drop target. |
