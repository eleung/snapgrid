...
<Callout type="info">
  ...
  sortable (a list, a kanban column), see [dnd-kit interop](/docs/guides/dnd-kit-interop).
</Callout>
...
<Callout type="info">
  ...
  [Nested grids](/docs/guides/nesting) — they also cross levels by default, and you can give a
