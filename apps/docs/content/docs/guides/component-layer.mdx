...
<Callout type="info">
  ...
  [floats itself](/docs/guides/headless#floating). See [Components](/docs/api/components) for the full
  prop tables and [Headless usage](/docs/guides/headless) for the hooks.
</Callout>
