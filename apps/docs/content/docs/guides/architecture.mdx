...
<Callout type="info">
  ...
  hooks](/docs/guides/headless) are the whole API for building grids. This page is for the curious —
...
and other draggables under one provider ([dnd-kit interop](/docs/guides/dnd-kit-interop)), and what
